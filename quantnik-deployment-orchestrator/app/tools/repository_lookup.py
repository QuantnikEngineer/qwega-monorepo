...
class RepositoryLookupClient:
    ...
    def _derive_pipeline_name_from_path(file_path: str) -> str:
        ...
        return stem if stem != 'azure-pipelines' else 'quantnik-azure-ci-pipeline'
    ...
    def _push_file_with_git(
        ...
        with tempfile.TemporaryDirectory(prefix='quantnik-repo-push-') as temp_dir:
