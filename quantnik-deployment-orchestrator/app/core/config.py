...
class Settings(BaseSettings):
    app_name: str = "Quantnik Deployment Orchestrator"
    ...
    repository_lookup_identity_header: str = Field(default="X-QUANTNIK-Principal")
    repository_lookup_roles_header: str = Field(default="X-QUANTNIK-Roles")
    ...
    repository_push_author_name: str = Field(default="QUANTNIK Build AI")
    repository_push_author_email: str = Field(default="quantnik-build-ai@local")
