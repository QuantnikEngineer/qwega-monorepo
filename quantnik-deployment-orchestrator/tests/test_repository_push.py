...
def test_push_file_with_git_commits_and_skips_unchanged_content(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr('app.tools.repository_lookup.settings.repository_push_author_name', 'QUANTNIK Build AI')
    monkeypatch.setattr('app.tools.repository_lookup.settings.repository_push_author_email', 'quantnik-build-ai@local')
