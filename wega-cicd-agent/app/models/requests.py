...
class AzureContainerAppsConfig(BaseModel):
    ...
    container_app_env_prefix: str = Field(default="wega-aca", alias="containerAppEnvPrefix", max_length=100)
...
def create_sample_request() -> GeneratePipelineRequest:
    return GeneratePipelineRequest(
        ...
        repository={
            "url": "https://github.com/example/wega-frontend.git",
            "branch": "main",
        },
        build={
            "language": "node",
            ...
            "image": {
                "repository": "registry.example.com/wega-frontend",
