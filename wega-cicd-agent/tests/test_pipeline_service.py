...
@pytest.mark.parametrize(
    ...
    [
        (
            "github-actions",
            [
                'docker build -t registry.example.com/wega-frontend:qa -t registry.example.com/wega-frontend:release-candidate .',
                'approval_gate:',
                'rollout_eastus:',
                'rollout_westeurope:',
            ],
        ...
        (
            ...
            [
                ...
                'docker push registry.example.com/wega-frontend:release-candidate',
            ],
        ),
        (
            "gitlab-ci",
