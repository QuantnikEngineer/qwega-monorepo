  ...
  const demoOptions = [
    {
      ...
      description: 'Interactive walkthrough of QUANTNIK\'s AI-powered engineering capabilities with a product expert.',
      icon: Play,
      duration: '45 minutes',
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground max-w-3xl">
            Experience the power of QUANTNIK's AI-driven software engineering platform. Schedule a personalized 
            ...
            <Card className="p-6 bg-card border border-border">
              ...
              <form className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  By submitting, you agree to our terms and privacy policy. A QUANTNIK representative will contact you within 24 hours.
                </p>
              </form>
            </Card>
          </div>
