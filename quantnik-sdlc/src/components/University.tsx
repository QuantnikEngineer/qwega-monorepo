...
export function University({ onBack, isDarkMode }: UniversityProps) {
  ...
  // QUANTNIK Platform Courses
  const quantnikPlatformCourses = [
    {
      title: 'QUANTNIK Platform Fundamentals',
      description: 'Master the core concepts and features of the QUANTNIK enterprise platform.',
      level: 'Beginner',
      duration: '4 hours',
      modules: 8,
      icon: GraduationCap,
    ...
    {
      title: 'AI Agent Orchestration with QUANTNIK',
    ...
    },
    {
      ...
      description: 'Integrate QUANTNIK into your existing enterprise ecosystem and manage deployments.',
      level: 'Advanced',
      duration: '8 hours',
      modules: 14,
      icon: Database,
  ...
  const learningPaths = [
    ...
    {
      name: 'QUANTNIK Platform Engineer Track',
      description: 'For platform teams implementing and managing QUANTNIK across the organization',
      courses: 10,
      duration: '45 hours',
      icon: Database,
      color: '#355493'
      ...
      <div className="relative h-[400px] w-full overflow-hidden bg-gradient-to-r from-[#351A55] to-[#3498B3] mb-8">
        ...
        <div className="relative max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-white mb-2">QUANTNIK University</h1>
            ...
            <Card className="overflow-hidden group cursor-pointer hover:shadow-lg transition-shadow">
              <div className="relative h-48 overflow-hidden">
                <ImageWithFallback 
                  ...
                  alt="QUANTNIK Platform"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4">
                  <Badge className="bg-[#BE266A] text-white mb-2">3 Courses</Badge>
                  <h3 className="text-white">QUANTNIK Platform Mastery</h3>
                </div>
              </div>
              <div className="p-4">
                <p className="text-muted-foreground text-sm mb-3">
                  Learn to leverage QUANTNIK for enterprise-scale AI-driven software engineering.
                </p>
        ...
        <div>
          ...
          <Tabs defaultValue="ai-fundamentals" className="w-full">
            <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <TabsTrigger value="quantnik-platform">QUANTNIK Platform</TabsTrigger>
            ...
            <TabsContent value="quantnik-platform">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {quantnikPlatformCourses.map((course, index) => renderCourseCard(course, index))}
              </div>
            </TabsContent>
