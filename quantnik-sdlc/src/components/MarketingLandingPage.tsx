...
import quantnikFramework from "figma:asset/0b25508f2bf48f950882df101afce14ebad87683.png";
  ...
  const testimonials = [
    {
      ...
      quote: "We're excited to be part of QUANTNIK's development journey. The early previews show tremendous potential for transforming enterprise development workflows.",
      rating: 5
    },
    {
    ...
    },
    {
      ...
      quote: "Based on our early access sessions, QUANTNIK will set a new standard for enterprise development platforms. The security-first approach is impressive.",
      rating: 5
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-card-foreground mb-4">
              How Does QUANTNIK Work?
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              QUANTNIK uses intelligent AI orchestration to analyze your software engineering tasks and automatically activate the right AI agents in the optimal sequence.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="bg-card rounded-xl p-8 border border-border shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Simply tell QUANTNIK what you want to accomplish in natural language. Whether it's "create a REST API endpoint," "debug authentication issues," or "deploy to production with full testing coverage."
              </p>
            </div>
            ...
            <div className="bg-card rounded-xl p-8 border border-border shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                QUANTNIK's AI orchestrator analyzes your request using intelligent intent detection to understand exactly what needs to be done, selecting from 50+ specialized AI agents across the entire SDLC.
              </p>
            </div>
