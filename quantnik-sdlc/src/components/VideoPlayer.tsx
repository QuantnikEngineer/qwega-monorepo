...
export function VideoPlayer({
  ...
  const getEmbedUrl = (url: string): string => {
    ...
    if (url.includes('wipro365.sharepoint.com')) {
      ...
      // For the specific QUANTNIK demo video
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-body-large max-w-3xl mx-auto text-white/90">
                Watch this comprehensive demonstration of QUANTNIK platform
                capabilities
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-body text-muted-foreground mb-8">
                This demo showcases QUANTNIK's capabilities in transforming
