...
export function CodeRepo({ onBack, onNavigateToRepoDetails, isDarkMode, onToggleTheme }: CodeRepoProps) {
  ...
  const repositories = [
    {
      name: 'wipro-quantnik-frontend',
      description: 'Main frontend application for QUANTNIK platform',
      project: 'QUANTNIK Platform',
      language: 'TypeScript',
      stars: 24,
      watchers: 8,
    ...
    {
      name: 'wipro-quantnik-backend',
      description: 'Backend services and APIs for QUANTNIK',
      project: 'QUANTNIK Platform',
      language: 'Java',
      stars: 18,
      watchers: 6,
    ...
    },
    {
      ...
      description: 'Cross-platform mobile application for QUANTNIK',
  ...
  const recentCommits = [
    {
      ...
      time: '2 hours ago',
      hash: 'a7b3c9d',
      repository: 'wipro-quantnik-frontend'
    },
    {
      ...
      time: '4 hours ago',
      hash: 'e2f5a8b',
      repository: 'wipro-quantnik-backend'
    },
    {
