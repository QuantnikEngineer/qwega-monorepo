...
export function Contact({ onBack, isDarkMode }: ContactProps) {
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      details: 'quantnik-support@wipro.com',
  ...
  const offices = [
    { region: 'North America', city: 'East Brunswick, NJ', contact: '+1 (888) QUANTNIK-HELP' },
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground max-w-3xl">
            Have questions about QUANTNIK? We're here to help. Reach out to our team for sales inquiries, 
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                ...
                support outside business hours, please use our emergency support line or email support@quantnik.ai 
