  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        { name: "Jira / Azure DevOps", icon: Trello, description: "Project management and issue tracking", url: "https://dev.azure.com/WiproPracticeWork/QUANTNIK2.0/_backlogs/backlog/QUANTNIK2.0%20Team/Epics" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Wiki", icon: BookMarked, description: "Developer documentation", url: "https://dev.azure.com/WiproPracticeWork/QUANTNIK2.0/_wiki/wikis/QUANTNIK%20wiki/1/Developer's-Platform" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Wiki", icon: BookMarked, description: "Asset documentation and guides", url: "https://dev.azure.com/WiproPracticeWork/QUANTNIK2.0/_wiki/wikis/QUANTNIK%20wiki/9/02.-Solution-Overview" },
