#!/bin/bash
# =============================================================================
# QUANTNIK Frontend - Deployment Script
# =============================================================================
# Usage:
#   ./deploy.sh                     # Deploy without profile
#   ./deploy.sh --profile dev       # Deploy with dev profile (dev-quantnik-sdlc)
...
SERVICE_BASE_NAME="quantnik-sdlc"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "QUANTNIK Frontend - Deployment Script"
    echo ""
...
echo ""
echo "=========================================="
echo "  QUANTNIK Frontend — Deployment"
echo "=========================================="
