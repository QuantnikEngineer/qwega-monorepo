...
```
┌──────────────────┐     ┌──────────────────┐     ┌──────────────────┐
│   Client/API     │────▶│  Wega Userstory  │────▶│   Vertex AI      │
...
git clone https://github.com/your-org/Wega-userstory-validator.git
cd Wega-userstory-validator
...
├── Wega-userstory-validator.service # Systemd service file
...
# Test locally
docker run -p 8080:8080 wega-userstory-validator:latest
...
```bash
gcloud run services logs read wega-userstory-validator --region us-central1
```
