    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-white/90 leading-relaxed mb-6 max-w-4xl">
                Specialized in implementing WEGA's AI-powered SDLC platform. I deploy advanced AI Agents and MCP (Model Context Protocol) integrations to transform software development teams into intelligent, autonomous organizations with AI-driven code generation, testing, and deployment capabilities.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="bg-background border-border">
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">WEGA SDLC APIs</Badge>
              ...
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Leverage WEGA's AI Agents to automate code review, testing, and deployment. Let developers focus on architecture and business logic while AI handles repetitive tasks.
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      <section className="py-16 bg-card">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground mb-8">
            How I spend my time deploying WEGA AI for software development teams
          </p>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        <h3 className="text-card-foreground">WEGA Implementation</h3>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Hands-on workshops with development teams on AI-assisted coding, demonstrate WEGA capabilities, gather feedback on AI suggestions, build developer trust.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Fine-tune AI models based on developer feedback, optimize MCP data flows, improve agent accuracy, coordinate with WEGA product team on custom features.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Travel to customer sites for WEGA implementations, AI Agent deployments, and SDLC transformation initiatives. Laptop + technical expertise required.
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      {/* Key WEGA AI Deployments */}
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl text-card-foreground mb-3">Key WEGA AI Deployments</h2>
          <p className="text-muted-foreground mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Deployed WEGA AI Agents to automate code review, testing, and deployment for Stripe's payment processing infrastructure. MCP integration with GitHub and Jira enabled seamless SDLC intelligence.
                </p>
                
                <div>
                  <p className="text-sm text-card-foreground mb-2">Technologies</p>
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary">WEGA AI Agents</Badge>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Implemented AI-powered test generation and deployment automation for Shopify's e-commerce platform. WEGA SDLC APIs enabled intelligent performance monitoring and release optimization.
                </p>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Deployed enterprise-grade WEGA compliance AI for financial services. Automated security scanning and regulatory code review ensure 100% compliance with financial industry standards.
                </p>
                
                <div>
                  <p className="text-sm text-card-foreground mb-2">Technologies</p>
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary">WEGA Compliance AI</Badge>
                    <Badge variant="secondary">Security Scanning</Badge>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Implemented WEGA AI Copilot for full-stack development teams. Context-aware code generation and MCP Slack/IDE integration created an intelligent development ecosystem.
                </p>
                
                <div>
                  <p className="text-sm text-card-foreground mb-2">Technologies</p>
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary">WEGA AI Copilot</Badge>
      ...
      <section className="py-16 bg-gradient-to-br from-[#351A55] via-[#355493] to-[#3498B3] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Discover how WEGA's MLOps engineers can help your team implement AI-powered development workflows.
          </p>
