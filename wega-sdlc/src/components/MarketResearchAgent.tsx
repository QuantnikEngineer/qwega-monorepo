  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m WEGA\'s Market Research Agent. I can help you analyze markets, identify opportunities, research competitors, understand customer segments, and gather market intelligence. How can I assist you today?',
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      const responseMessage: Message = {
        ...
        role: 'assistant',
        content: `I've received your market research request.${fileInfo} I'll analyze this using the ${selectedLLM} model with focus on market insights, competitive intelligence, and strategic opportunities. This is a simulated response in the pre-launch version of WEGA.`,
        timestamp: new Date(),
      };
