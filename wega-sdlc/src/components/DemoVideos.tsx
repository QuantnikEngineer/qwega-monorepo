...
const demoVideos: VideoItem[] = [
  ...
  {
    id: "wega-intro-short",
    title: "WEGA Intro - Short",
    description:
      "Get a quick overview of WEGA platform capabilities and see how it revolutionizes enterprise software development with integrated AI-powered tools and automated workflows.",
    thumbnail: uniformThumbnail,
    videoUrl:
  ...
  {
    id: "wega-intro-long",
    title: "WEGA Intro - Long",
    description:
      "Dive deep into the comprehensive WEGA ecosystem, exploring advanced features, enterprise integrations, and real-world implementation scenarios that drive digital transformation.",
    thumbnail: uniformThumbnail,
    videoUrl:
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-body-large max-w-3xl mx-auto text-white/90">
                Explore WEGA platform capabilities through
          ...
          <div className="text-center mt-16">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-body text-muted-foreground mb-8">
                ...
                WEGA's capabilities. Contact us to see how
