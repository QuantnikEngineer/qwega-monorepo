...
import wegaFrameworkImage from 'figma:asset/8d22fc96f13915bddaccf1f591d30c4d310c1e04.png';
...
export function About({ onBack, isDarkMode }: AboutProps) {
  const features = [
    ...
    },
    {
      ...
      description: 'From requirements gathering to deployment, WEGA covers the entire software development lifecycle.',
      color: '#3498B3'
    },
    {
      icon: Zap,
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="relative grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-slate-300 text-lg leading-relaxed mb-8">
                WEGA transforms enterprise software engineering with AI-powered automation, intelligent insights, and unified development workflows. Experience the next-generation platform that seamlessly integrates development, testing, infrastructure, and deployment into one powerful AI-enhanced ecosystem.
              </p>
          ...
          <Card className="p-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-2 border-[#355493]/20 shadow-lg">
            <div className="text-center mb-16" style={{ marginBottom: 'calc(4rem + 2px)' }}>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                WEGA is Wipro's AI-powered enterprise software engineering platform designed to transform how organizations approach development, testing, and deployment through intelligent automation and unified workflows.
              </p>
            </div>
                ...
                <div className="w-full h-96 relative overflow-hidden rounded-2xl shadow-lg bg-muted/50">
                  <Dialog open={isImageDialogOpen} onOpenChange={setIsImageDialogOpen}>
                    ...
                    <DialogContent className="!w-[1200px] !h-[912px] !max-w-none !max-h-none p-0 overflow-hidden">
                      <DialogTitle className="sr-only">WEGA Framework</DialogTitle>
                      <DialogDescription className="sr-only">
                        Expanded view of the WEGA AI-powered enterprise software engineering platform framework
                      </DialogDescription>
                      <div className="relative">
                        <img 
                          src={wegaFrameworkImage}
        ...
        <section className="py-20 bg-muted/30 mb-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Discover how WEGA transforms enterprise workflows and see our strategic integration timeline for comprehensive platform deployment
              </p>
            </div>
        ...
        <Card className="p-8 mb-12 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-2 border-[#355493]/20 shadow-lg">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-card-foreground mb-4">
                WEGA Target state aligned to different fabric layers and Wipro Ecosystem
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="flex justify-center">
              <div className="relative w-full max-w-[1200px] h-[531px] rounded-2xl overflow-hidden shadow-xl">
                <img 
                  ...
                  alt="WEGA BuildIQ Layers Architecture"
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
              WEGA Grid – MCP Catalog (Our Assets, Partnership)
            </h2>
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Explore our comprehensive ecosystem of enterprise assets, partnerships, and microservices that power WEGA's intelligent platform capabilities
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-[1200px] h-[550px] rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback 
                ...
                alt="WEGA Grid – MCP Catalog showing our assets and partnerships" 
                className="w-full h-full object-contain"
              />
            </div>
          </div>
        ...
        <Card className="p-8 bg-gradient-to-r from-[#351A55] to-[#3498B3] border-0 shadow-2xl">
          <div className="text-center text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              WEGA is currently in pre-launch. Request early access to experience the future of AI-powered software engineering.
            </p>
