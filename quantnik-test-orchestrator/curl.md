...
Base URL: `https://quantnik-test-orchestrator-204952354085.us-central1.run.app`
...
### Health Check
```bash
curl https://quantnik-test-orchestrator-204952354085.us-central1.run.app/health
```
...
{
  "status": "healthy",
  "service": "Quantnik Test Orchestrator"
}
```

### Detailed Health Check
```bash
curl https://quantnik-test-orchestrator-204952354085.us-central1.run.app/health/detailed
```
...
### Root Endpoint
```bash
curl https://quantnik-test-orchestrator-204952354085.us-central1.run.app/
```
...
```bash
curl -X POST https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/chat \
...
```bash
curl -X POST https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/chat/simple \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/chat/stream \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://quantnik-test-orchestrator-204952354085.us-central1.run.app/api/v1/prompt/analyze \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/memory/sess_test_001
```
...
```bash
curl "https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/memory/sess_test_001/history?limit=20"
```
...
```bash
curl -X DELETE https://quantnik-test-orchestrator-204952354085.us-central1.run.app/v1/memory/sess_test_001
```
