#!/bin/bash
# =============================================================================
# Quantnik Test Orchestrator - Deployment Script
# =============================================================================
# Usage:
#   ./deploy.sh                     # Deploy without profile (service name: quantnik-test-orchestrator)
#   ./deploy.sh --profile dev       # Deploy with dev profile (service name: dev-quantnik-test-orchestrator)
...
SERVICE_BASE_NAME="quantnik-test-orchestrator"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "Quantnik Test Orchestrator - Deployment Script"
    echo ""
