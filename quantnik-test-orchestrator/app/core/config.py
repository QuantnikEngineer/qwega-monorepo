...
class Settings(BaseSettings):
    """Application Settings for Quantnik Test Orchestrator"""
    
    # Application Info
    app_name: str = "Quantnik Test Orchestrator"
    ...
    def get_test_scenario_agent_url(self) -> str:
        ...
        return f"https://{prefix}quantnik-userstory-to-testcases-agent-{self.gcp_project_number}.{self.gcp_region}.run.app"
    ...
    def get_test_script_agent_url(self) -> str:
        ...
        prefix = get_profile_prefix(self.app_profile)
        return f"https://{prefix}quantnik-testcase-to-scripts-agent-{self.gcp_project_number}.{self.gcp_region}.run.app"
    ...
    def get_test_data_agent_url(self) -> str:
        ...
        prefix = get_profile_prefix(self.app_profile)
        return f"https://{prefix}quantnik-testcases-to-testdata-agent-{self.gcp_project_number}.{self.gcp_region}.run.app"
    ...
    def get_planning_orchestrator_url(self) -> str:
        ...
        prefix = get_profile_prefix(self.app_profile)
        return f"https://dev-quantnik-planning-orchestrator-{self.gcp_project_number}.{self.gcp_region}.run.app"
