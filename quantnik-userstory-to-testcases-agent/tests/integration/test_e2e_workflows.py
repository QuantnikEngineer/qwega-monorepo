...
class TestGreenFieldWorkflow:
    ...
    def test_single_story_jira_xray_workflow(self, sample_user_story, mock_vertex_ai_response, jira_config, xray_config):
        ...
        # Mock test plan ID lookup (TEST_PLAN_KEY defaults to QUANTNIK-875)
        responses.add(
            responses.GET,
            "https://quantnikbuildiq.atlassian.net/rest/api/3/issue/QUANTNIK-875",
            json={"id": "99999", "key": "QUANTNIK-875"},
            status=200
        )
        # Jira issue lookup
        responses.add(
        ...
        responses.add(
            responses.GET,
            "https://quantnikbuildiq.atlassian.net/rest/api/3/issue/TEST-100",
            json={"id": "10002", "key": "TEST-100"},
            status=200
        )
        responses.add(
            responses.GET,
            "https://quantnikbuildiq.atlassian.net/rest/api/3/issue/TEST-101",
            json={"id": "10003", "key": "TEST-101"},
            status=200
        )
        # Xray authentication
