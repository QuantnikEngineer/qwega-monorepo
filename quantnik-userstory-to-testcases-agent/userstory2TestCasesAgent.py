...
TEST_PLAN_KEY = os.getenv("TEST_PLAN_KEY", "QUANTNIK-875")
XRAY_GRAPHQL_URL = os.getenv("XRAY_GRAPHQL_URL", "https://xray.cloud.getxray.app/api/v2/graphql")

jira_config = {
    "base_url":    os.getenv("JIRA_BASE_URL",    "https://quantnikbuildiq.atlassian.net/"),
    "username":    os.getenv("JIRA_USERNAME",    "harsh.65@wipro.com"),
    "api_token":   os.getenv("JIRA_API_TOKEN",   ""),
    "project_key": os.getenv("JIRA_PROJECT_KEY", "QUANTNIKAIDEMO"),
}
...
Required structure:
{
  "updated_test_cases": [
    {
      "existing_key": "<Jira key e.g. QUANTNIK-123 — use null for brand-new cases>",
      "Test Case Name": "<name>",
      "Test Case Description": "<description>",
      "Steps": [
        {
