...
- Org: `default`
- Project: `QUANTNIK_Build_AI`
- AWS Account: `145748108830`
- AWS Region: `ap-south-1`
- EKS Cluster: `quantnik-dev-eks`
- Namespace: `quantnik-demo`
...
All repositories deploy to the same namespace: `quantnik-demo`.
...
- Environment: `quantnikdev`
- Infrastructure: `quantnikdeveksinfra`
