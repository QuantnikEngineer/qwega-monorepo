...
from app.core.resilience import run_in_thread, vertex_breaker
...
class Embedder:
    ...
    async def embed_query(self, query: str) -> list[float]:
        ...
        try:
            result = await run_in_thread(self._model.get_embeddings, [query])
    ...
    async def _embed_batch_with_retry(
        ...
        for attempt in range(RETRY_LIMIT):
            try:
                results = await run_in_thread(self._model.get_embeddings, texts)
