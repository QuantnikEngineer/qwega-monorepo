...
====================
Centralized configuration for Wega Auth Service.
...
class Settings(BaseSettings):
    """Application Settings for Wega Auth Service."""

    # Application Info
    app_name: str = "Wega Auth Service"
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/wega_auth",
    ...
    wega_secret_key: Optional[str] = Field(
        default=None,
    ...
    def model_post_init(self, __context):
        ...
        if self.gcp_project_number and "wega-frontend" in self.frontend_url:
            prefix = self.gcp_profile_prefix or "dev-"
            corrected = f"https://{prefix}wega-sdlc-{self.gcp_project_number}.{self.gcp_region}.run.app"
