#!/bin/bash
# =============================================================================
# Quantnik SDLC Orchestrator - Deployment Script
# =============================================================================
# Usage:
#   ./deploy.sh                     # Deploy without profile (service name: quantnik-sdlc-orchestrator)
#   ./deploy.sh --profile dev       # Deploy with dev profile (service name: dev-quantnik-sdlc-orchestrator)
...
SERVICE_BASE_NAME="quantnik-sdlc-orchestrator"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "Quantnik SDLC Orchestrator - Deployment Script"
    echo ""
