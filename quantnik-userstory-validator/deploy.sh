#!/bin/bash
# Deployment script for Quantnik-Userstory-Validator to digital-rig-poc project
...
ZONE="us-central1-a"
INSTANCE_NAME="quantnik-validator-instance"
MACHINE_TYPE="e2-medium"
SERVICE_ACCOUNT="204952354085-compute@developer.gserviceaccount.com"

echo "=========================================="
echo "Deploying Quantnik-Userstory-Validator to GCP"
