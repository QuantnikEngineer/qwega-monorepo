...
logger.info("Starting Quantnik Userstory Validator server")
    ...
    200:
      ...
      schema:
        ...
        properties:
          ...
          service:
            type: string
            example: Quantnik Userstory Validator
  """
  logger.info("Health check endpoint called")
  return jsonify({"status": "healthy", "service": "Quantnik Userstory Validator"}), 200
...
def analyze_brd():
      ...
      schema:
        ...
        properties:
          ...
          confluence_link:
            ...
            example: "https://quantnikbuildiq.atlassian.net/wiki/spaces/WAAD/pages/36962305/BRD+Page"
  responses:
    200:
  ...
  try:
    ...
    logger.info("Analysis completed successfully, returning from Quantnik-userstory-validator endpoint")
