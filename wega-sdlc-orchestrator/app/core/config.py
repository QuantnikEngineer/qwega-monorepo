...
class Settings(BaseSettings):
    ...
    # Application Info
    app_name: str = "Wega SDLC Orchestrator"
    ...
    def get_test_orchestrator_url(self) -> str:
        ...
        prefix = get_profile_prefix(self.app_profile)
        return f"https://{prefix}wega-test-orchestrator-{self.gcp_project_number}.{self.gcp_region}.run.app"
    ...
    def get_common_integration_orchestrator_url(self) -> str:
        ...
        return f"https://{prefix}wega-common-integration-service-{self.gcp_project_number}.{self.gcp_region}.run.app"
