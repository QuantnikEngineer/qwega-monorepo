#!/bin/bash
# =============================================================================
# Wega SDLC Orchestrator - Deployment Script
# =============================================================================
# Usage:
#   ./deploy.sh                     # Deploy without profile (service name: wega-sdlc-orchestrator)
#   ./deploy.sh --profile dev       # Deploy with dev profile (service name: dev-wega-sdlc-orchestrator)
...
SERVICE_BASE_NAME="wega-sdlc-orchestrator"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "Wega SDLC Orchestrator - Deployment Script"
    echo ""
