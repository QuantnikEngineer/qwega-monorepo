# Wega SDLC Orchestrator

Parent orchestrator for WEGA SDLC workflow automation. This service intelligently routes requests to specialized child orchestrators based on intent classification.
...
| `PLANNING_ORCHESTRATOR_URL` | Planning orchestrator URL | https://dev-wega-planning-orchestrator-... |
| `TEST_ORCHESTRATOR_URL` | Test orchestrator URL | https://dev-wega-test-orchestrator-... |
| `COMMON_INTEGRATION_ORCHESTRATOR_URL` | Common Integration orchestrator URL | https://dev-wega-common-integration-service-... |
...
```bash
docker build -t wega-sdlc-orchestrator .
docker run -p 8081:8081 --env-file .env wega-sdlc-orchestrator
```
...
- [wega-planning-orchestrator](../Wega-planning-orchestrator) - Planning child orchestrator
- [wega-test-orchestrator](../Wega-test-orchestrator) - Test child orchestrator
- [wega-common-integration-service](../Wega-common-integration-service) - Common Integration child orchestrator
