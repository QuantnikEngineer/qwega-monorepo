...
Quantnikum is built around three production guarantees:
...
```powershell
docker build -t quantnikum:latest .
docker run --rm -p 8080:8080 --env-file .env quantnikum:latest
```
