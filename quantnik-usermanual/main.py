...
APP_TITLE = "Quantnikum – User Manual Generator API"
APP_VERSION = "1.0.0"
...
def _build_confluence_title(project_name: str, state: Dict[str, Any]) -> str:
    ...
    Example:
        project_name     = "QUANTNIK"
        extraction title = "Auto-pay-CC Automated Credit Card Payments"
        →  "QUANTNIK - Auto-pay-CC Automated Credit Card Payments"
...
async def run_quantnikum_pipeline(
    prompt: Optional[str] = None,
    project_name: Optional[str] = None,
) -> Dict[str, Any]:
    """Create a new unique session, run the Quantnikum pipeline, and return state.
...
class GenerateManualRequest(BaseModel):
    ...
    url: str = Field(
        ...
        json_schema_extra={
            "example": "https://wipro365.sharepoint.com/sites/BuildIQ/Shared Documents/QUANTNIK"
        },
    )
    ...
    project_name: str = Field(
        ...
        json_schema_extra={"example": "QUANTNIK User Manual"},
    )
    ...
    model_config = {"json_schema_extra": {"examples": [
        {"url": "https://wipro365.sharepoint.com/sites/BuildIQ/Shared Documents/QUANTNIK", "project_name": "QUANTNIK User Manual"},
        {"url": "https://quantnikbuildiq.atlassian.net/wiki/spaces/WAAD/pages/81330177/My+Page", "project_name": "My Page Manual"},
    ]}}
...
class GenerateManualResponse(BaseModel):
    ...
    confluence_url: Optional[str] = Field(
        ...
        json_schema_extra={"example": "https://quantnikbuildiq.atlassian.net/wiki/spaces/WAAD/pages/12345678/QUANTNIK+User+Manual"},
    )
                    ...
                    with _override_env(**env_overrides):
                        ...
                        try:
                            state = await asyncio.wait_for(
                                run_quantnikum_pipeline(project_name=body.project_name),
