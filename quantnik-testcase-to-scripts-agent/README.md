...
```bash
cd /Users/pr20347584/Desktop/A2A/Harness_Repo/quantnik-planning-design/testcase_to_script_agent
```
...
This project is part of the Harness Repo/QUANTNIK Planning Design suite.
