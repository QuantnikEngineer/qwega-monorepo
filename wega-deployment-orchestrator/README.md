...
└───────────────────────────────────────┬─────────────────────────────────────┘
                                        ...
                                        ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│                  WEGA DEPLOYMENT ORCHESTRATOR (This Project)                │
│                               Port 8091                                     │
│                                                                             │
│  ┌────────────────────────────────────────────────────────────────────┐    │
...
```json
{
    ...
    "context": {
        ...
        "entities": {
            "project_name": "wega-payment-service",
            "language": "python"
        }
    },
...
```env
CI_AGENT_URL=https://wega-ci-agent-204952354085.us-central1.run.app
CD_AGENT_URL=https://wega-cd-agent-204952354085.us-central1.run.app
```
...
```bash
cd wega-deployment-orchestrator
python -m venv .venv
...
```bash
docker build -t wega-deployment-orchestrator .
docker run -p 8091:8091 --env-file .env wega-deployment-orchestrator
```
...
- [WEGA CI Agent](../wega-ci-agent) - Pipeline generation service
- [WEGA SDLC Frontend](../wega-sdlc) - CI Pipeline Workspace UI
