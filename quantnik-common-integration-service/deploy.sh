#!/bin/bash
# =============================================================================
# Quantnik Common Integration Service - Deployment Script
# =============================================================================
# Usage:
#   ./deploy.sh                     # Deploy without profile (service name: quantnik-common-integration-service)
#   ./deploy.sh --profile dev       # Deploy with dev profile (service name: dev-quantnik-common-integration-service)
...
# Default values
SERVICE_BASE_NAME="quantnik-common-integration-service"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "Quantnik Common Integration Service - Deployment Script"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./deploy.sh                          # Deploy as quantnik-common-integration-service"
    echo "  ./deploy.sh --profile dev            # Deploy as dev-quantnik-common-integration-service"
    echo "  ./deploy.sh -p qa -r us-east1        # Deploy as qa-quantnik-common-integration-service in us-east1"
