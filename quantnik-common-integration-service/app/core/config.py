...
class Settings(BaseSettings):
    """Application Settings for Quantnik Common Integration Service"""
    
    # Application Info
    app_name: str = "Quantnik Common Integration Service"
    ...
    def get_rag_agent_url(self) -> str:
        ...
        return f"https://{prefix}quantnik-rag-{self.gcp_project_number}.{self.gcp_region}.run.app"
