"""
Quantnik Common Integration Service - Main Application
===================================================
...
async def lifespan(app: FastAPI):
    ...
    logger.info(
        f"[{FILE_NAME}] Starting Quantnik Common Integration Service",
    ...
    logger.info(f"[{FILE_NAME}] Shutting down Quantnik Common Integration Service")


app = FastAPI(
    title="Quantnik Common Integration Service",
    description="""
