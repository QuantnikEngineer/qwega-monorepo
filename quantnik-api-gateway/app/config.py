...
class Settings(BaseSettings):
    ...
    app_name: str = "Quantnik API Gateway"
    ...
    def model_post_init(self, __context):
        ...
        Mirrors the pattern in deploy.sh:
          ORCHESTRATOR_URL = https://{prefix}quantnik-sdlc-orchestrator-{number}.{region}.run.app
          PLANNING_URL     = https://{prefix}quantnik-planning-orchestrator-{number}.{region}.run.app
          TESTCASE_URL     = https://{prefix}quantnik-userstory-to-testcases-agent-{number}.{region}.run.app
