#!/bin/bash
# =============================================================================
# QUANTNIK API Gateway - Deployment Script
# =============================================================================

set -e

SERVICE_BASE_NAME="quantnik-api-gateway"
PROFILE=""
REGION="us-central1"
PROJECT=""
DRY_RUN=false
...
show_help() {
    echo "QUANTNIK API Gateway - Deployment Script"
    echo ""
...
AUTH_SERVICE_NAME="${PROFILE_PREFIX}quantnik-auth-service"
ORCHESTRATOR_SERVICE_NAME="${PROFILE_PREFIX}quantnik-sdlc-orchestrator"
PLANNING_SERVICE_NAME="${PROFILE_PREFIX}quantnik-planning-orchestrator"
TESTCASE_SERVICE_NAME="${PROFILE_PREFIX}quantnik-userstory-to-testcases-agent"
RAG_SERVICE_NAME="${PROFILE_PREFIX}quantnik-rag"
