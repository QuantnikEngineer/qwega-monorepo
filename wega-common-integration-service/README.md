...
LangGraph-based orchestrator for context enrichment operations. This service acts as a child orchestrator for the `wega-sdlc-orchestrator`, handling all RAG (Retrieval-Augmented Generation) knowledge base operations.
...
| `RAG_AGENT_URL` | RAG Agent base URL | https://dev-wega-rag-... |
...
```bash
docker build -t wega-common-integration-service .
docker run -p 8002:8002 --env-file .env wega-common-integration-service
```
...
|---------|--------------|-------------|
| (none) | `wega-common-integration-service` | Default |
| `dev` | `dev-wega-common-integration-service` | Development |
| `qa` | `qa-wega-common-integration-service` | QA/Testing |
| `stage` | `stage-wega-common-integration-service` | Staging |
| `prod` | `wega-common-integration-service` | Production |
...
- [wega-sdlc-orchestrator](../Wega-sdlc-orchestrator) - Parent orchestrator
- [wega-test-orchestrator](../Wega-test-orchestrator) - Sibling orchestrator for test operations