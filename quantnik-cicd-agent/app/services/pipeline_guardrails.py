...
def normalize_harness_pipeline_yaml(request: GeneratePipelineRequest, content: str) -> str:
    ...
    try:
        ...
        raise PipelineValidationError([
            'Harness YAML normalization requires PyYAML. Install pyyaml in the Quantnik CI Agent environment.',
        ]) from exc
    ...
    pipeline['identifier'] = _safe_identifier(str(pipeline.get('identifier') or pipeline_name), 'quantnik_pipeline')
