...
export function getMcpServersFromEnv() {
  ...
  // Atlassian/Jira MCP
  if ((process.env.MCP_ATLASSIAN_TOKEN || process.env.MCP_ATLASSIAN_EMAIL) && !process.env.MCP_ATLASSIAN_URL) {
    console.warn('[config] MCP_ATLASSIAN_TOKEN/EMAIL are set but MCP_ATLASSIAN_URL is missing — Atlassian MCP will be skipped. Set MCP_ATLASSIAN_URL=https://<your-domain>.atlassian.net in .env to enable it.');
  }
