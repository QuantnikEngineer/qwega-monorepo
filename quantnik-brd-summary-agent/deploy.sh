#!/bin/bash
# Deployment script for BRD Summary Agent to digital-rig-poc project
...
ZONE="us-central1-a"
INSTANCE_NAME="brd-summary-agent"
MACHINE_TYPE="e2-medium"
SERVICE_ACCOUNT="204952354085-compute@developer.gserviceaccount.com"

echo "=========================================="
echo "Deploying BRD Summary Agent to GCP"
...
cd /opt/brd-agent-gcp && pip3 install -r requirements.txt
...
echo ""
echo "View logs:"
echo "  gcloud compute ssh $INSTANCE_NAME --zone=$ZONE --command='sudo journalctl -u brd-summary -f'"
echo ""
