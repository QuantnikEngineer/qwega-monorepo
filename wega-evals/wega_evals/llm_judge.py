...
from wega_evals.agent_profile import AgentProfile
from wega_evals.config import EvalConfig
from wega_evals.models import DimensionScore, EvalResult
...
def _ensure_ca_bundle() -> None:
    ...
    """
    if os.environ.get("_WEGA_EVALS_CA_DONE"):
        return
    if os.environ.get("SSL_CERT_FILE"):
        os.environ["_WEGA_EVALS_CA_DONE"] = "1"
        return
    ...
    try:
        ...
        td = tempfile.mkdtemp(prefix="wega_evals_certs_")
