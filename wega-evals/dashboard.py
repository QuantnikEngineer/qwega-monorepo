"""Wega Evals Console - single-page Streamlit app.
...
from wega_evals.views import evaluation_view, observability_view


# ── Page setup + routing state ──────────────────────────────────────

page_setup("Wega Evals Console", "🧭")
...
if view == "eval":
    ...
    if not scores_df.empty:
        ...
        st.info(
            "// no evaluation data yet - run `wega-eval --agent <name> run --dataset <name>` "
