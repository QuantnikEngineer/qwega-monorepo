"""
QUANTNIK Anomaly Agent - Main Application Entry Point
...
def create_app() -> FastAPI:
    ...
    async def startup_event():
        ...
        logger.info(f"Starting QUANTNIK Anomaly Agent v1.0.0")
    ...
    async def shutdown_event():
        ...
        import logging
        logger = logging.getLogger("anomaly-agent")
        logger.info("Shutting down QUANTNIK Anomaly Agent")
