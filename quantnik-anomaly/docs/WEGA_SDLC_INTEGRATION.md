# QUANTNIK-SDLC Integration Guide

**Platform:** Ubuntu 22.04 LTS (AWS EC2)  
**Last Updated:** 2026-04-29

This document lists all changes required in the `quantnik-sdlc` frontend to integrate the Anomaly Agent with Dashboard + Chatbot UI.
 ...
 * Communicates with the QUANTNIK Anomaly Agent container
 */
...
'/anomaly-agent': 'http://quantnik-anomaly-agent.quantnik-system.svc.cluster.local'
```
