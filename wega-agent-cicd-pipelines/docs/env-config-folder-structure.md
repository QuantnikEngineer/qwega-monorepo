...
env:
  ...
  AUTH_SERVICE_URL: https://dev-wega-auth-service-xxxxx.run.app
  
  # Database
  DB_HOST: dev-postgres.wega.internal
  DB_PORT: "5432"
  DB_NAME: wega_dev
  
  # Cache
  REDIS_HOST: dev-redis.wega.internal
  REDIS_PORT: "6379"
...
env:
  ...
  API_BASE_URL: https://qa-api.wega.example.com
  AUTH_SERVICE_URL: https://qa-wega-auth-service-xxxxx.run.app
  
  DB_HOST: qa-postgres.wega.internal
  DB_PORT: "5432"
  DB_NAME: wega_qa
  
  REDIS_HOST: qa-redis.wega.internal
  REDIS_PORT: "6379"
...
env:
  ...
  API_BASE_URL: https://staging-api.wega.example.com
  AUTH_SERVICE_URL: https://staging-wega-auth-service-xxxxx.run.app
  
  DB_HOST: staging-postgres.wega.internal
  DB_PORT: "5432"
  DB_NAME: wega_staging
  
  REDIS_HOST: staging-redis.wega.internal
  REDIS_PORT: "6379"
...
env:
  ...
  API_BASE_URL: https://api.wega.example.com
  AUTH_SERVICE_URL: https://wega-auth-service-xxxxx.run.app
  
  DB_HOST: prod-postgres.wega.internal
  DB_PORT: "5432"
  DB_NAME: wega_prod
  
  REDIS_HOST: prod-redis.wega.internal
  REDIS_PORT: "6379"
...
env:
  ...
  API_BASE_URL: https://dev-api.wega.azurecontainer.io
  AUTH_SERVICE_URL: https://dev-wega-auth.azurecontainer.io
  
  # Azure Database
  DB_HOST: dev-wega-db.postgres.database.azure.com
  DB_PORT: "5432"
  DB_NAME: wega_dev
  
  # Azure Cache for Redis
  REDIS_HOST: dev-wega-redis.redis.cache.windows.net
  REDIS_PORT: "6380"
  REDIS_SSL: "true"
...
env:
  ...
  API_BASE_URL: https://api.wega.azurecontainer.io
  AUTH_SERVICE_URL: https://wega-auth.azurecontainer.io
  
  DB_HOST: prod-wega-db.postgres.database.azure.com
  DB_PORT: "5432"
  DB_NAME: wega_prod
  
  REDIS_HOST: prod-wega-redis.redis.cache.windows.net
  REDIS_PORT: "6380"
  REDIS_SSL: "true"
...
env:
  ...
  API_BASE_URL: https://dev-api.wega.aws.example.com
  AUTH_SERVICE_URL: https://dev-wega-auth.ecs.aws.example.com
  
  # AWS RDS
  DB_HOST: dev-wega-db.xxxxx.us-east-1.rds.amazonaws.com
  DB_PORT: "5432"
  DB_NAME: wega_dev
  
  # AWS ElastiCache
  REDIS_HOST: dev-wega-redis.xxxxx.cache.amazonaws.com
  REDIS_PORT: "6379"
...
env:
  ...
  API_BASE_URL: https://api.wega.aws.example.com
  AUTH_SERVICE_URL: https://wega-auth.ecs.aws.example.com
  
  DB_HOST: prod-wega-db.xxxxx.us-east-1.rds.amazonaws.com
  DB_PORT: "5432"
  DB_NAME: wega_prod
  
  REDIS_HOST: prod-wega-redis.xxxxx.cache.amazonaws.com
  REDIS_PORT: "6379"
...
*WEGA CI/CD - Environment Configuration Structure*
