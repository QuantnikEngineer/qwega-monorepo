# AWS ECS Setup Scripts for WEGA 3.0

Scripts to set up AWS ECS infrastructure for WEGA 3.0 deployments.
...
4. ECR repositories created for all WEGA images
...
Creates task definitions and ECS services for all 23 WEGA services.
...
| Dev | `wega-ecs-dev` |
| QA | `wega-ecs-qa` |
| Stage | `wega-ecs-stage` |
| Production | `wega-ecs-prod` |
...
for repo in wega-brd-backend wega-sdlc-frontend wega-auth-service-backend ...; do
