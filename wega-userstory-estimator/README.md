# WEGA User Story Estimator

FastAPI service for estimating story points from direct lists of epics and user stories when orchestrators are unavailable locally. The service mirrors the WEGA BRD and WEGA User Story project structure while providing a direct estimation API backed by synthetic historical data.
