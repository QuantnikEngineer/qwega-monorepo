"""Session revocation tests — QUANTNIK-1920 / QUANTNIK-1921.

QUANTNIK-1920: role/capability change revokes active refresh sessions.
QUANTNIK-1921: deactivation revokes sessions, /auth/refresh validates user status,
...
# ---------------------------------------------------------------------------
# QUANTNIK-1920 — Role / capability change revokes active sessions
# ---------------------------------------------------------------------------


@pytest.mark.integration
class TestRoleChangeRevokesSessions:
    """QUANTNIK-1920: changing a user's role assignments invalidates refresh tokens."""
...
# ---------------------------------------------------------------------------
# QUANTNIK-1921 — Deactivation revokes, refresh validates status,
...
class TestDeactivationRevokesSessions:
    """QUANTNIK-1921: deactivating a user revokes their refresh sessions."""
...
class TestRefreshValidatesUserStatus:
    """QUANTNIK-1921: /auth/refresh rejects tokens for non-ACTIVE users."""
...
class TestReactivationForcesPasswordReset:
    """QUANTNIK-1921: reactivation flips must_change_password on the auth method."""
