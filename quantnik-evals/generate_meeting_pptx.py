"""Generate meeting PowerPoint: Quantnik-Evals Review & Assessment Plan."""
...
def generate_pptx():
    ...
    _add_textbox(slide, Inches(1), Inches(2), Inches(11), Inches(1.2),
                 "Quantnik-Evals", font_size=48, color=WHITE, bold=True,
    ...
    _add_bullet_slide(prs, "Agenda", [
        "1. Review Quantnik-Evals evaluation framework and architecture",
    ...
    # ══════════════════════════════════════════════════════════════
    #  SLIDE 3 — What is Quantnik-Evals
    # ══════════════════════════════════════════════════════════════
    _add_bullet_slide(prs, "1. What is Quantnik-Evals?", [
    ...
    # ══════════════════════════════════════════════════════════════
    _add_bullet_slide(prs, "What Makes Quantnik-Evals Unique", [
    ...
    _add_bullet_slide(prs, "Zero-Trace Agents — Action Needed", [
        ...
        "Option B: Manually create synthetic dataset items using CLI (quantnik-eval add-item)",
    ...
    _add_table_slide(prs, "Deployment Structure — Evolution Plan",
        ...
        [
            ["Current", "Developer runs CLI locally (quantnik-eval run)", "Quick iteration, debugging, flexibility"],
