"""CLI entry point for the quantnik-evals framework.
...
Usage:
    ...
    quantnik-eval --agent user_story run --dataset user-story-eval
"""
...
import quantnik_evals.profiles.cara  # noqa: F401
import quantnik_evals.profiles.brd_summary  # noqa: F401
import quantnik_evals.profiles.brd  # noqa: F401
import quantnik_evals.profiles.user_story  # noqa: F401
import quantnik_evals.profiles.userstory_validator  # noqa: F401
import quantnik_evals.profiles.userstory_to_testcases  # noqa: F401
import quantnik_evals.profiles.testcases_to_testdata  # noqa: F401
import quantnik_evals.profiles.testcase_to_scripts  # noqa: F401
import quantnik_evals.profiles.sdlc_orchestrator  # noqa: F401
import quantnik_evals.profiles.code_assistant  # noqa: F401
import quantnik_evals.profiles.user_manual  # noqa: F401

from quantnik_evals.agent_profile import get_profile, list_profiles
...
from quantnik_evals.runner import EvalRunner
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="quantnik-evals: Reusable LLM Agent Evaluation Framework",
    )
    parser.add_argument(
        "--agent", "-a",
        default="",
